...
var outputContractCoverageInventory = map[string]outputContractCoverageEntry{
	...
	"insertion_ack":     {Variants: []string{"success"}},
	...
	"plugin_manage":            {Variants: []string{"list", "inspect", "validate", "install", "update", "enable", "disable", "member_enable", "member_disable", "remove"}},
	"plugin_load":              {Variants: []string{"success"}},
