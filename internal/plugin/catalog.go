...
func (m *Store) LoadCatalog(ctx context.Context, request SourceRequest) (Catalog, error) {
...
func (m *Store) loadCatalogDefinition(ctx context.Context, request SourceRequest) (stagedPluginSource, catalogDefinition, error) {
...
func (m *Store) stageCatalogEntry(ctx context.Context, request SourceRequest) (stagedPluginSource, error) {
